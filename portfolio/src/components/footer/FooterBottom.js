  ...
  return (
    <div className='w-full py-10 flex flex-col'>
        <div>
            ...
            © 2024 Supun Akalanka. All rights reserved. | Designed by <a href='https://www.linkedin.com/in/supun-akalanka-420203294/' target='_blank' rel='noopener noreferrer' className='text-designColor'>Supun Akalanka</a>
            </p>
        </div>

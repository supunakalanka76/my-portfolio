  ...
  return (
    <div className='w-full h-1/4 group flex'>
      <div className='w-10 h-[6px] bgOpacity mt-16 relative'>
        <span className='absolute w-5 h-5 rounded-full top-2 left-3 flex justify-center items-center bg-bgBlack bg-opacity-60'>
      ...
      <div className='w-full bg-bgBlack bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg px-10 flex flex-col justify-center gap-10 shadow-shadowOne'>
        ...
        <div className='flex justify-between items-center font-poppins'>
            ...
            <div>
                {/* <p className='w-20 h-10 text-designColor bg-bgBlack bg-opacity-25 rounded-lg flex justify-center items-center shadow-shadowOne text-sm font-medium'>
                    {result}
                </p> */}
            </div>
        </div>
